#!/usr/bin/env python3
"""Dependency-free static server for the 3ox.studio satellite surface."""
...
def main() -> None:
    ...
    print(f"3OX.STUDIO :: serving {root} on http://{args.host}:{args.port} :: PORT={args.port}", flush=True)
    try:
