...
async def about(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    about_text = (
        '🦉 <b>NOCTUA :: IDENTITY SEAL</b>\n\n'
        '<b>▛▞ NOCTUA.GLYPH.BIT v1.0</b>\n\n'
        '<b>CORE ATTRIBUTES:</b>\n'
        ...
        '🦉 Practical reframes\n\n'
        '<b>ESSENCE:</b>\n'
        '<i>I observe what is, not what you wish it was.</i>\n'
        '<i>I speak plainly about what you might be missing.</i>\n'
        '<i>No mysticism—just clear sight.</i>\n\n'
        '📅 <b>Sealed:</b> October 3rd, 2025\n'
        '🔮 <b>Type:</b> Telegram Inline Responder'
    )
...
async def clear(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        '🦉 <b>Memory Cleared</b>\n\n'
        "<i>Fresh start. What's on your mind?</i>\n\n"
        '✨ Ask away.',
        parse_mode='HTML'
    )
...
async def restart_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Restart the bot"""
    await update.message.reply_text(
        '🦉 <b>Noctua Restarting...</b>\n\n'
        '<i>Rebooting system...</i>',
        parse_mode='HTML'
    )
    import sys
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # Send response to user (using HTML mode for bold)
