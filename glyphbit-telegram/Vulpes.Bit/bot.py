...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_banner = (
        '🦊 <b>VULPES :: GLYPHBIT v1.0</b>\n'
        '<i>The Sly Fox Awakens</i>\n\n'
        ...
        '🦊 <i>Ask away—and don\'t worry, I bite gently.</i>'
    )
...
async def about(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    about_text = (
        '🦊 <b>VULPES :: IDENTITY SEAL</b>\n\n'
        '<b>VULPES.GLYPH.BIT v1.0</b>\n\n'
        '<b>CORE ATTRIBUTES:</b>\n'
        ...
        '<b>ESSENCE:</b>\n'
        '<i>I answer your questions with clarity,</i>\n'
        '<i>then grin at the edges of your hesitation.</i>\n'
        '<i>The fox way: help first, tease after.</i>\n\n'
        '📅 <b>Created:</b> October 5th, 2025\n'
        '🔮 <b>Type:</b> Telegram Playful Helper'
    )
