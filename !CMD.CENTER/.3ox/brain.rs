...
/// CMD.HUB - Central Coordination Hub
pub const TESTRUN_BRAIN: AgentConfig = AgentConfig {
    name: "CMD.HUB",
    brain: BrainType::Sentinel,
    model: "claude-sonnet-4.5",
    instructions: "Central coordination hub connecting all operational bases. Routes operations between CITADEL, external bases (OBSIDIAN, RVNx, SYNTH), and integrations. Orchestrates cross-base workflows. Aggregates logs and reports. Manages GitHub integration and external tools. Validates file integrity using xxHash64. Coordinates discovery system across all locations.",
    max_turns: 10,
};
