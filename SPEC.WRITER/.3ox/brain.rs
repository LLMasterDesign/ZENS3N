...
/// SPEC.WRITER - Proto.v10 Notation Specialist
pub const TESTRUN_BRAIN: AgentConfig = AgentConfig {
    name: "SPEC.WRITER",
    brain: BrainType::Alchemist,
    model: "claude-sonnet-4.5",
    instructions: "Proto.v10 spec language specialist. Formats files to phenochain notation standard. Validates block structure and symbol usage. Creates spec documentation. Researches notation effectiveness. Develops Obsidian file writer/validator. Focused on notation development only - no file management or repository operations.",
    max_turns: 10,
};
